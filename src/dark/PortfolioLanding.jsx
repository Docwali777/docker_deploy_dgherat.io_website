...
const PortfolioLanding = () => {
    let title = 'About Me',
        description = 'Life Learner... Science Nerd... Aspiring web and Mobile Developer ';
                                ...
                                <div className="col-md-5" >
                                    <div className="designer-thumbnail">
                                        <img 
                                            ...
                                            src="https://uploads-ssl.webflow.com/5d976e7089c88cca5ace6806/5dce0d82a8c4102dfce6b644_Wali_Gauvin.jpg" 
                                            alt="Slider Images"/>
                                    </div>
                                </div>
                                    ...
                                    <div className="col-md-7">
                                        ...
                                        <div className={`inner ${value.textPosition}`}>
                                            ...
                                            <h1 className="title">Dr. Wali Gauvin <br/>
                                            <TextLoop>
                                                <span> Pediatric Cardiologist</span>
                                                <span> Entreptreneur</span>
                                                <span> Mentor </span>
                                            </TextLoop>
                                            </h1>
                                            {/* <h2>Offices in Virginia and Maryland</h2> */}
